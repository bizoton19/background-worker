...
bus_service = ServiceBusService(service_namespace="cpsc-topic", shared_access_key_name="RootManageSharedAccessKey",
                                shared_access_key_value="FG76GE6eVG0HfdRFp9d7+opJMp4qhluotQIxAVpGmEw=")
